...
{
    // Scope always comes from the authenticated user's assigned branch.
    // A genuinely unassigned platform user operates on Platform Default.
    // Client-provided branch_id is intentionally ignored.
    ...
    json_error('No branch is assigned to this user.', 403);
    return null;
}
...

{
    ...
    try {
        ...
        foreach ($values as $key => $value) {
            ...
            // Explicit Save persists every submitted value at this user scope.
