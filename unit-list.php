    ...
    <div class="card-header">
        <div class="form-row">
            <div class="field col-8">
                ...
                <input id="masterSearch" type="text" autocomplete="off" placeholder="Search units...">
            </div>
...
(function ($, window, document) {
    ...
    var table = AppDataTable.init("#masterTable", {
        ...
        searching: true,
        searchDelay: 350,
        appSearchPlaceholder: "Search Units...",
        ...
        language:{emptyTable:"No units found.",zeroRecords:"No matching units found."},
    ...
    document.addEventListener("click",function(event){
        ...
        }).catch(function(error){App.showError(error,"Unable to update Unit status.");})
