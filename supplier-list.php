    ...
    <div class="card-header">
        <div class="form-row">
            <div class="field col-8">
                ...
                <input id="masterSearch" type="text" autocomplete="off" placeholder="Search suppliers...">
            </div>
...
(function ($, window, document) {
    ...
    var table = AppDataTable.init("#masterTable", {
        ...
        searching: true,
        searchDelay: 350,
        appSearchPlaceholder: "Search Suppliers...",
        ...
        language:{emptyTable:"No suppliers found.",zeroRecords:"No matching suppliers found."},
