...
(function (window, document) {
    ...
    function sectionUrl(section) {
        return "api/settings.php?section=" + encodeURIComponent(section);
    }

    function addScope(body) {
        // API determines scope exclusively from the authenticated user.
        return body;
    }
    ...
    async function loadMail() {
        ...
        try {
            ...
            var result = await App.api("api/mail-settings.php");
    ...
    mailForm.addEventListener("submit", async function (event) {
        ...
        try {
            ...
            var result = await App.api("api/mail-settings.php", { method: "PUT", body: mailPayload() });
    ...
    testMailButton.addEventListener("click", async function () {
        ...
        try {
            ...
            var result = await App.api("api/mail-settings.php", { method: "POST", body: body });
